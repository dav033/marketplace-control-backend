...
const providers: Provider[] = [
  {
    ...
    rating: 4.8, review_count: 42, status: 'candidate', discovery_source: 'Prompt v2.8 · muestra', contact_email: null, last_activity: 'Ayer',
  },
  {
    provider_id: 'demo-2', display_name: 'Muestra: Estudio Luz Caribe', category: 'Fotografía', city: 'Barranquilla',
    rating: 4.7, review_count: 31, status: 'under_review', discovery_source: 'Prompt v2.8 · muestra', contact_email: 'pendiente', last_activity: 'Hace 2 días',
  },
  {
    provider_id: 'demo-3', display_name: 'Muestra: Sonido Patio', category: 'Música', city: 'Medellín',
    rating: 4.9, review_count: 87, status: 'approved', discovery_source: 'Prompt v2.8 · muestra', contact_email: 'registrado', last_activity: 'Hace 4 días',
  },
  {
    provider_id: 'demo-4', display_name: 'Muestra: Salón La Estación', category: 'Venues', city: 'Bogotá',
    rating: 4.6, review_count: 119, status: 'candidate', discovery_source: 'Prompt v2.8 · muestra', contact_email: null, last_activity: 'Hace 5 días',
  },
];
