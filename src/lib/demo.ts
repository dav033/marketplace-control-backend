...
const providers: Provider[] = [
  {
    ...
    rating: 4.8, review_count: 42, contact_channel: 'whatsapp', status: 'candidate', discovery_source: 'Prompt v2.8 · muestra', contact_email: null, last_activity: 'Ayer', platform_count: 2, additional_categories: ['Entretenimiento'],
  },
  {
    provider_id: 'demo-2', display_name: 'Muestra: Estudio Luz Caribe', category: 'Fotografía', city: 'Barranquilla',
    rating: 4.7, review_count: 31, contact_channel: 'whatsapp', status: 'under_review', discovery_source: 'Prompt v2.8 · muestra', contact_email: 'pendiente', last_activity: 'Hace 2 días', platform_count: 1, additional_categories: [],
  },
  {
    provider_id: 'demo-3', display_name: 'Muestra: Sonido Patio', category: 'Música', city: 'Medellín',
    rating: 4.9, review_count: 87, contact_channel: 'email', status: 'approved', discovery_source: 'Prompt v2.8 · muestra', contact_email: 'registrado', last_activity: 'Hace 4 días', platform_count: 1, additional_categories: [],
  },
  {
    provider_id: 'demo-4', display_name: 'Muestra: Salón La Estación', category: 'Venues', city: 'Bogotá',
    rating: 4.6, review_count: 119, contact_channel: 'whatsapp', status: 'candidate', discovery_source: 'Prompt v2.8 · muestra', contact_email: null, last_activity: 'Hace 5 días', platform_count: 3, additional_categories: ['Comida y Bebida', 'Entretenimiento'],
  },
];
