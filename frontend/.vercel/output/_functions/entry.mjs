...
import { A as REROUTABLE_STATUS_CODES, D as ASTRO_GENERATOR, E as ASTRO_ERROR_HEADER, F as decodeKey, I as decryptString, L as generateCspDigest, M as fetchStateSymbol, N as originPathnameSymbol, O as DEFAULT_404_COMPONENT, P as responseSentSymbol$1, S as renderEndpoint, T as isRoute500, _ as normalizeCspResourceEntry, b as markHTMLString, d as renderTemplate, g as isRenderInstruction, i as renderComponent, j as clientAddressSymbol, k as REDIRECT_STATUS_CODES, l as renderSlotToString, n as renderPage, o as chunkToString, r as renderJSX, s as createSlotValueFromString, u as isRenderTemplateResult, v as pushDirective, w as isRoute404, y as isAstroComponentFactory } from "./chunks/server_BgOX8cb3.mjs";
...
var middlewareSecret = "6a5e226a-4658-480a-94d0-7648f1c4fb44";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/campanas/index.astro",
			"pathname": "/campanas",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/chat-prueba.astro",
			"pathname": "/chat-prueba",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/configuracion.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/formularios/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/preregistrados",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/preregistrados\\/?$",
			"segments": [[{
				"content": "preregistrados",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/preregistrados.astro",
			"pathname": "/preregistrados",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/proveedores/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/proveedores/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["token"],
			"component": "src/pages/registro/[token].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_RN_UEPxJ.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/_.._nhDUZFFS.mjs");
var _page2 = () => import("./chunks/index_DEC5Zt1n.mjs");
var _page3 = () => import("./chunks/chat-prueba_BnAe44-h.mjs");
var _page4 = () => import("./chunks/configuracion_BM44tIV7.mjs");
var _page5 = () => import("./chunks/_id__DNgE9nYT.mjs");
var _page6 = () => import("./chunks/index_DK9dFhOs.mjs");
var _page7 = () => import("./chunks/preregistrados_DXszLu3Q.mjs");
var _page8 = () => import("./chunks/_id__BTWLv1he.mjs");
var _page9 = () => import("./chunks/index_9_jIIPEJ.mjs");
var _page10 = () => import("./chunks/_token__BOXdKbzp.mjs");
var _page11 = () => import("./chunks/index_DH22q7yj.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/[...path].ts", _page1],
	["src/pages/campanas/index.astro", _page2],
	["src/pages/chat-prueba.astro", _page3],
	["src/pages/configuracion.astro", _page4],
	["src/pages/formularios/[id].astro", _page5],
	["src/pages/formularios/index.astro", _page6],
	["src/pages/preregistrados.astro", _page7],
	["src/pages/proveedores/[id].astro", _page8],
	["src/pages/proveedores/index.astro", _page9],
	["src/pages/registro/[token].astro", _page10],
	["src/pages/index.astro", _page11]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/davidt/Desktop/marketplace-control/frontend/","cacheDir":"file:///C:/Users/davidt/Desktop/marketplace-control/frontend/node_modules/.astro/","outDir":"file:///C:/Users/davidt/Desktop/marketplace-control/frontend/dist/","srcDir":"file:///C:/Users/davidt/Desktop/marketplace-control/frontend/src/","publicDir":"file:///C:/Users/davidt/Desktop/marketplace-control/frontend/public/","buildClientDir":"file:///C:/Users/davidt/Desktop/marketplace-control/frontend/dist/client/","buildServerDir":"file:///C:/Users/davidt/Desktop/marketplace-control/frontend/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/[...path]","isIndex":false,"type":"endpoint","pattern":"^\\/api(?:\\/(.*?))?\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"...path","dynamic":true,"spread":true}]],"params":["...path"],"component":"src/pages/api/[...path].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"external","src":"_astro/index.Daq0HVb3.css"}],"routeData":{"route":"/campanas","isIndex":true,"type":"page","pattern":"^\\/campanas\\/?$","segments":[[{"content":"campanas","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/campanas/index.astro","pathname":"/campanas","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"inline","content":".chat-grid[data-astro-cid-ehfugmbz]{grid-template-columns:minmax(0,1.5fr) minmax(0,1fr);align-items:start;gap:18px;display:grid}.chat-panel[data-astro-cid-ehfugmbz]{flex-direction:column;min-height:0;display:flex}.chat-hilo[data-astro-cid-ehfugmbz]{flex-direction:column;gap:10px;min-height:380px;max-height:58vh;padding:18px;display:flex;overflow-y:auto}.chat-burbuja[data-astro-cid-ehfugmbz]{white-space:pre-line;border-radius:13px;max-width:78%;padding:10px 13px;font-size:13px;line-height:1.5}.chat-burbuja[data-astro-cid-ehfugmbz].bot{color:var(--text);background:var(--surface-2);border:1px solid var(--line);align-self:flex-start}.chat-burbuja[data-astro-cid-ehfugmbz].persona{color:#04120a;background:var(--accent);align-self:flex-end}.chat-form[data-astro-cid-ehfugmbz]{border-top:1px solid var(--line);gap:9px;padding:14px 18px;display:flex}.chat-form[data-astro-cid-ehfugmbz] .form-input[data-astro-cid-ehfugmbz]{flex:1}.chat-nota[data-astro-cid-ehfugmbz]{padding:0 18px;font-size:12px}.chat-candidato[data-astro-cid-ehfugmbz]{border-bottom:1px solid var(--line);gap:6px;padding:14px 18px;display:grid}.chat-candidato[data-astro-cid-ehfugmbz] label[data-astro-cid-ehfugmbz]{color:var(--text-subtle);letter-spacing:.08em;text-transform:uppercase;font-size:10px;font-weight:700}.chat-borrador[data-astro-cid-ehfugmbz]{gap:11px;margin:0;padding:16px 18px 20px;display:grid}.chat-borrador[data-astro-cid-ehfugmbz] div[data-astro-cid-ehfugmbz]{gap:3px;display:grid}.chat-borrador[data-astro-cid-ehfugmbz] dt[data-astro-cid-ehfugmbz]{color:var(--text-subtle);letter-spacing:.08em;text-transform:uppercase;font-size:10px;font-weight:700}.chat-borrador[data-astro-cid-ehfugmbz] dd[data-astro-cid-ehfugmbz]{color:var(--text);margin:0;font-size:13px}.chat-borrador[data-astro-cid-ehfugmbz] .pendiente[data-astro-cid-ehfugmbz] dd[data-astro-cid-ehfugmbz]{color:var(--text-subtle)}@media (width<=900px){.chat-grid[data-astro-cid-ehfugmbz]{grid-template-columns:1fr}}\n"}],"routeData":{"route":"/chat-prueba","isIndex":false,"type":"page","pattern":"^\\/chat-prueba\\/?$","segments":[[{"content":"chat-prueba","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/chat-prueba.astro","pathname":"/chat-prueba","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"inline","content":".settings-list[data-astro-cid-brm5xtdu]{gap:0;margin:0;padding:0;list-style:none;display:grid}.settings-list[data-astro-cid-brm5xtdu] li[data-astro-cid-brm5xtdu]{border-top:1px solid var(--line);justify-content:space-between;align-items:center;gap:15px;padding:17px 0;display:flex}.settings-list[data-astro-cid-brm5xtdu] li[data-astro-cid-brm5xtdu]:first-child{border-top:0}.settings-list[data-astro-cid-brm5xtdu] strong[data-astro-cid-brm5xtdu],.settings-list[data-astro-cid-brm5xtdu] small[data-astro-cid-brm5xtdu]{display:block}.settings-list[data-astro-cid-brm5xtdu] strong[data-astro-cid-brm5xtdu]{font-size:12px}.settings-list[data-astro-cid-brm5xtdu] small[data-astro-cid-brm5xtdu]{color:var(--text-subtle);margin-top:4px;font-size:11px}.settings-list[data-astro-cid-brm5xtdu] b[data-astro-cid-brm5xtdu]{white-space:nowrap;border-radius:7px;padding:5px 9px;font-size:10px}.check-state[data-astro-cid-brm5xtdu]{color:var(--ok);background:var(--ok-bg)}.pending-state[data-astro-cid-brm5xtdu]{color:var(--warn);background:var(--warn-bg)}.zona-riesgo[data-astro-cid-brm5xtdu]{border-color:var(--danger)!important}.zona-riesgo[data-astro-cid-brm5xtdu] h2[data-astro-cid-brm5xtdu]{color:var(--danger)}.zona-texto[data-astro-cid-brm5xtdu]{color:var(--text-muted);max-width:62ch;margin:0 0 13px;font-size:12px;line-height:1.55}.zona-texto[data-astro-cid-brm5xtdu] strong[data-astro-cid-brm5xtdu]{color:var(--text)}.zona-conteo[data-astro-cid-brm5xtdu]{border:1px solid var(--line);background:var(--surface-2);color:var(--text-muted);font:11px var(--font-mono);border-radius:9px;padding:10px 13px}.zona-acciones[data-astro-cid-brm5xtdu]{flex-wrap:wrap;align-items:flex-end;gap:11px;margin-top:13px;display:flex}.zona-confirmar[data-astro-cid-brm5xtdu]{color:var(--text);flex:230px;gap:6px;font-size:11px;font-weight:600;display:grid}.zona-confirmar[data-astro-cid-brm5xtdu] code[data-astro-cid-brm5xtdu]{background:var(--surface-2);color:var(--danger);font:11px var(--font-mono);border-radius:3px;padding:1px 5px}.danger-button[data-astro-cid-brm5xtdu]{border:1px solid var(--danger);background:var(--danger-bg);min-height:38px;color:var(--danger);cursor:pointer;border-radius:9px;padding:0 15px;font-size:12px;font-weight:600}.danger-button[data-astro-cid-brm5xtdu]:disabled{opacity:.42;cursor:not-allowed}.danger-button[data-astro-cid-brm5xtdu]:not(:disabled):hover{background:var(--danger);color:var(--bg)}.zona-estado[data-astro-cid-brm5xtdu]{min-height:17px;color:var(--text-muted);margin:11px 0 0;font-size:12px}@media (width<=560px){.zona-acciones[data-astro-cid-brm5xtdu]{flex-direction:column;align-items:stretch}.danger-button[data-astro-cid-brm5xtdu]{width:100%}}\n"}],"routeData":{"route":"/configuracion","isIndex":false,"type":"page","pattern":"^\\/configuracion\\/?$","segments":[[{"content":"configuracion","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/configuracion.astro","pathname":"/configuracion","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"inline","content":".secondary-button[data-astro-cid-xzpop3ly]{border:1px solid var(--line);min-height:40px;color:var(--text);background:var(--surface-2);opacity:.55;cursor:not-allowed;border-radius:10px;align-items:center;padding:0 16px;font-size:12px;font-weight:600;display:inline-flex}.checklist[data-astro-cid-xzpop3ly]{color:var(--text-muted);gap:16px;margin:0;padding:0;font-size:12px;line-height:1.45;list-style:none;display:grid}.checklist[data-astro-cid-xzpop3ly] li[data-astro-cid-xzpop3ly]{align-items:center;gap:10px;display:flex}.checklist[data-astro-cid-xzpop3ly] span[data-astro-cid-xzpop3ly]{width:26px;height:26px;color:var(--accent);background:var(--accent-soft);border-radius:8px;place-items:center;font-size:10px;font-weight:700;display:grid}\n"}],"routeData":{"route":"/formularios/[id]","isIndex":false,"type":"page","pattern":"^\\/formularios\\/([^/]+?)\\/?$","segments":[[{"content":"formularios","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/formularios/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"}],"routeData":{"route":"/formularios","isIndex":true,"type":"page","pattern":"^\\/formularios\\/?$","segments":[[{"content":"formularios","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/formularios/index.astro","pathname":"/formularios","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"inline","content":".count-chip[data-astro-cid-f7emkagt]{border:1px solid var(--line);color:var(--text-muted);background:var(--surface-2);border-radius:999px;align-self:center;padding:7px 13px;font-size:12px;font-weight:600}.prereg-grid[data-astro-cid-f7emkagt]{gap:14px;display:grid}.prereg[data-astro-cid-f7emkagt]{padding:20px 22px}.prereg-head[data-astro-cid-f7emkagt]{justify-content:space-between;align-items:flex-start;gap:16px;display:flex}.prereg-nombre[data-astro-cid-f7emkagt]{color:var(--text);font-size:16px;font-weight:650;text-decoration:none}.prereg-nombre[data-astro-cid-f7emkagt]:hover{color:var(--accent)}.prereg-meta[data-astro-cid-f7emkagt]{flex-wrap:wrap;gap:6px;margin-top:8px;display:flex}.prereg-repu[data-astro-cid-f7emkagt]{color:var(--text);white-space:nowrap;justify-items:end;gap:2px;font-size:13px;display:grid}.prereg-repu[data-astro-cid-f7emkagt] small[data-astro-cid-f7emkagt]{color:var(--text-subtle);font-size:11px}.prereg-datos[data-astro-cid-f7emkagt]{border-top:1px solid var(--line);grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:12px;margin:18px 0 0;padding:16px 0 0;display:grid}.prereg-datos[data-astro-cid-f7emkagt] div[data-astro-cid-f7emkagt]{gap:3px;display:grid}.prereg-datos[data-astro-cid-f7emkagt] dt[data-astro-cid-f7emkagt]{color:var(--text-subtle);letter-spacing:.08em;text-transform:uppercase;font-size:10px;font-weight:700}.prereg-datos[data-astro-cid-f7emkagt] dd[data-astro-cid-f7emkagt]{color:var(--text);overflow-wrap:anywhere;margin:0;font-size:13px}.prereg-aviso[data-astro-cid-f7emkagt]{border:1px solid var(--line-strong);color:var(--text-muted);background:var(--surface-2);border-radius:9px;margin:14px 0 0;padding:10px 12px;font-size:12px;line-height:1.5}.prereg-listas[data-astro-cid-f7emkagt]{margin-top:14px}.prereg-etiqueta[data-astro-cid-f7emkagt]{color:var(--text-subtle);letter-spacing:.08em;text-transform:uppercase;margin-bottom:7px;font-size:10px;font-weight:700;display:block}.prereg-tags[data-astro-cid-f7emkagt]{flex-wrap:wrap;gap:6px;display:flex}.prereg-nota[data-astro-cid-f7emkagt]{color:var(--text-muted);margin:14px 0 0;font-size:12px;line-height:1.55}.prereg-pie[data-astro-cid-f7emkagt]{border-top:1px solid var(--line);justify-content:space-between;align-items:center;gap:12px;margin-top:18px;padding-top:14px;font-size:11px;display:flex}.consent-si[data-astro-cid-f7emkagt]{color:var(--accent);font-weight:600}.consent-no[data-astro-cid-f7emkagt]{color:var(--text-subtle)}\n"}],"routeData":{"route":"/preregistrados","isIndex":false,"type":"page","pattern":"^\\/preregistrados\\/?$","segments":[[{"content":"preregistrados","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/preregistrados.astro","pathname":"/preregistrados","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"inline","content":".platform-list[data-astro-cid-g7xg7fmw]{gap:8px;margin:0;padding:0;list-style:none;display:grid}.platform-list[data-astro-cid-g7xg7fmw] li[data-astro-cid-g7xg7fmw]{border-top:1px solid var(--line);align-items:center;gap:10px;padding:9px 0;font-size:12px;display:flex}.platform-list[data-astro-cid-g7xg7fmw] li[data-astro-cid-g7xg7fmw]:first-child{border-top:0}.platform-name[data-astro-cid-g7xg7fmw]{min-width:110px;font-weight:700}.platform-score[data-astro-cid-g7xg7fmw]{color:var(--signal-text)}.platform-reviews[data-astro-cid-g7xg7fmw]{color:var(--text-muted);flex:1}.meta-chip-extra[data-astro-cid-g7xg7fmw]{opacity:.75}\n"}],"routeData":{"route":"/proveedores/[id]","isIndex":false,"type":"page","pattern":"^\\/proveedores\\/([^/]+?)\\/?$","segments":[[{"content":"proveedores","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/proveedores/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"external","src":"_astro/index.CuptoqrG.css"}],"routeData":{"route":"/proveedores","isIndex":true,"type":"page","pattern":"^\\/proveedores\\/?$","segments":[[{"content":"proveedores","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/proveedores/index.astro","pathname":"/proveedores","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"inline","content":".registro[data-astro-cid-f56pdx2q] h1[data-astro-cid-f56pdx2q]{text-wrap:balance}.opcional[data-astro-cid-f56pdx2q]{color:var(--text-subtle);font-weight:400}.campo[data-astro-cid-f56pdx2q]{gap:7px;display:grid}.campo-head[data-astro-cid-f56pdx2q]{flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:6px;display:flex}.campo-label[data-astro-cid-f56pdx2q]{color:var(--text);font-size:13px;font-weight:600}.campo-count[data-astro-cid-f56pdx2q]{color:var(--text-subtle);font:11px var(--font-mono);font-variant-numeric:tabular-nums}.campo-count[data-astro-cid-f56pdx2q].lleno{color:var(--signal-text)}.campo-help[data-astro-cid-f56pdx2q]{color:var(--text-muted);margin:0;font-size:12px;line-height:1.45}.campo-add[data-astro-cid-f56pdx2q]{gap:8px;display:flex}.campo-add[data-astro-cid-f56pdx2q] .form-input[data-astro-cid-f56pdx2q]{flex:1;min-width:0}.campo-add[data-astro-cid-f56pdx2q] .secondary-button[data-astro-cid-f56pdx2q]{flex:none}.fichas[data-astro-cid-f56pdx2q]{flex-wrap:wrap;gap:7px;margin:3px 0 0;padding:0;list-style:none;display:flex}.fichas[data-astro-cid-f56pdx2q]:empty{display:none}.ficha[data-astro-cid-f56pdx2q]{border:1px solid var(--accent-soft);background:var(--accent-soft);color:var(--accent-text);border-radius:999px;align-items:center;gap:7px;padding:5px 7px 5px 11px;font-size:12px;display:inline-flex}.ficha[data-astro-cid-f56pdx2q] button[data-astro-cid-f56pdx2q]{width:18px;height:18px;color:inherit;cursor:pointer;background:#00000047;border:0;border-radius:50%;place-items:center;padding:0;font-size:13px;line-height:1;display:grid}.ficha[data-astro-cid-f56pdx2q] button[data-astro-cid-f56pdx2q]:hover{background:#00000073}.opciones[data-astro-cid-f56pdx2q]{flex-wrap:wrap;gap:7px;display:flex}.opcion[data-astro-cid-f56pdx2q]{border:1px solid var(--line-strong);background:var(--surface-2);min-height:34px;color:var(--text-muted);font:inherit;cursor:pointer;border-radius:999px;padding:0 13px;font-size:12px}.opcion[data-astro-cid-f56pdx2q]:hover:not(:disabled):not([aria-pressed=true]){border-color:var(--text-subtle);color:var(--text)}.opcion[data-astro-cid-f56pdx2q][aria-pressed=true]{border-color:var(--accent);background:var(--accent-soft);color:var(--accent-text);font-weight:600}.opcion[data-astro-cid-f56pdx2q]:disabled{opacity:.38;cursor:not-allowed}.volumen[data-astro-cid-f56pdx2q]{border:1px solid var(--line);background:var(--surface-2);border-radius:11px;padding:14px}.volumen-row[data-astro-cid-f56pdx2q]{align-items:center;gap:9px;display:flex}.volumen-row[data-astro-cid-f56pdx2q] .form-input[data-astro-cid-f56pdx2q]{text-align:center;font-variant-numeric:tabular-nums;width:100%}.volumen-row[data-astro-cid-f56pdx2q] span[data-astro-cid-f56pdx2q]{color:var(--text-subtle);flex:none;font-size:12px}.volumen-barra[data-astro-cid-f56pdx2q]{background:var(--rail);border-radius:3px;height:5px;margin:14px 0 8px;position:relative;overflow:hidden}.volumen-barra[data-astro-cid-f56pdx2q] i[data-astro-cid-f56pdx2q]{background:var(--accent);border-radius:3px;transition:left .18s,right .18s;position:absolute;top:0;bottom:0}.volumen-escala[data-astro-cid-f56pdx2q]{color:var(--text-subtle);font:10px var(--font-mono);justify-content:space-between;display:flex}.volumen-resultado[data-astro-cid-f56pdx2q]{color:var(--text-muted);margin:11px 0 0;font-size:12px}.volumen-resultado[data-astro-cid-f56pdx2q].invalido{color:var(--danger)}.form-error[data-astro-cid-f56pdx2q]{border:1px solid var(--line-strong);background:var(--danger-bg);color:var(--danger);border-radius:10px;margin:0;padding:10px 13px;font-size:12px}.form-nota[data-astro-cid-f56pdx2q]{color:var(--text-subtle);text-align:center;margin:-4px 0 0;font-size:11px}@media (width<=520px){.campo-add[data-astro-cid-f56pdx2q]{flex-direction:column}.campo-add[data-astro-cid-f56pdx2q] .secondary-button[data-astro-cid-f56pdx2q]{width:100%}}\n"}],"routeData":{"route":"/registro/[token]","isIndex":false,"type":"page","pattern":"^\\/registro\\/([^/]+?)\\/?$","segments":[[{"content":"registro","dynamic":false,"spread":false}],[{"content":"token","dynamic":true,"spread":false}]],"params":["token"],"component":"src/pages/registro/[token].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AppLayout.Dv_Rtpeg.css"},{"type":"inline","content":".notice[data-astro-cid-lcdefpme]{border:1px solid var(--warn-line);color:var(--warn);background:var(--warn-bg);border-radius:10px;align-items:center;gap:9px;margin:-8px 0 21px;padding:11px 14px;font-size:12px;display:flex}.notice-dot[data-astro-cid-lcdefpme]{background:var(--warn);border-radius:50%;width:7px;height:7px}.notice[data-astro-cid-lcdefpme] code[data-astro-cid-lcdefpme]{background:var(--surface-2);font-family:var(--font-mono);border-radius:5px;padding:2px 5px;font-size:11px}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/campanas/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/chat-prueba.astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/configuracion.astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/formularios/[id].astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/formularios/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/preregistrados.astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/proveedores/[id].astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/proveedores/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/registro/[token].astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/[...path]@_@ts":"chunks/_.._nhDUZFFS.mjs","\u0000virtual:astro:page:src/pages/proveedores/[id]@_@astro":"chunks/_id__BTWLv1he.mjs","\u0000virtual:astro:page:src/pages/formularios/[id]@_@astro":"chunks/_id__DNgE9nYT.mjs","\u0000virtual:astro:page:src/pages/registro/[token]@_@astro":"chunks/_token__BOXdKbzp.mjs","\u0000virtual:astro:page:src/pages/chat-prueba@_@astro":"chunks/chat-prueba_BnAe44-h.mjs","\u0000virtual:astro:page:src/pages/configuracion@_@astro":"chunks/configuracion_BM44tIV7.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_RN_UEPxJ.mjs","\u0000virtual:astro:page:src/pages/proveedores/index@_@astro":"chunks/index_9_jIIPEJ.mjs","\u0000virtual:astro:page:src/pages/campanas/index@_@astro":"chunks/index_DEC5Zt1n.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DH22q7yj.mjs","\u0000virtual:astro:page:src/pages/formularios/index@_@astro":"chunks/index_DK9dFhOs.mjs","\u0000virtual:astro:page:src/pages/preregistrados@_@astro":"chunks/preregistrados_DXszLu3Q.mjs","C:/Users/davidt/Desktop/marketplace-control/frontend/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_DM7kHAhh.mjs","C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/registro/[token].astro?astro&type=script&index=0&lang.ts":"_astro/_token_.astro_astro_type_script_index_0_lang.D9_OWx_q.js","C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/chat-prueba.astro?astro&type=script&index=0&lang.ts":"_astro/chat-prueba.astro_astro_type_script_index_0_lang.DvVxnZrU.js","C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/configuracion.astro?astro&type=script&index=0&lang.ts":"_astro/configuracion.astro_astro_type_script_index_0_lang.DLNy7Cwd.js","C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/campanas/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.BwEdIz2s.js","C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/proveedores/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.pSqK3ihJ.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/registro/[token].astro?astro&type=script&index=0&lang.ts","var e=document.querySelector(`#registro-form`);if(e){let t=[],n=[],r=document.querySelector(`#products-input`),i=document.querySelector(`#products-add`),a=document.querySelector(`#products-list`),o=document.querySelector(`#products-count`),s=document.querySelector(`#products-field`),c=document.querySelector(`#services-count`),l=document.querySelector(`#services-field`),u=document.querySelector(`#volume-min`),d=document.querySelector(`#volume-max`),f=document.querySelector(`#volume-fill`),p=document.querySelector(`#volume-result`),m=document.querySelector(`#form-error`);function h(){if(!a||!o)return;a.replaceChildren(...t.map((e,n)=>{let r=document.createElement(`li`);r.className=`ficha`,r.append(e);let i=document.createElement(`button`);return i.type=`button`,i.setAttribute(`aria-label`,`Quitar ${e}`),i.textContent=`×`,i.addEventListener(`click`,()=>{t.splice(n,1),h()}),r.append(i),r}));let e=t.length>=10;o.textContent=`${t.length} / 10`,o.classList.toggle(`lleno`,e),i&&(i.disabled=e),r&&(r.disabled=e,r.placeholder=e?`Llegaste al máximo de diez`:`Ej. cobertura de boda completa`),s&&(s.value=JSON.stringify(t))}function g(){let e=document.querySelectorAll(`.opcion`),t=n.length>=5;e.forEach(e=>{let r=e.dataset.categoria??``,i=n.includes(r);e.setAttribute(`aria-pressed`,String(i)),e.disabled=!i&&t}),c&&(c.textContent=`${n.length} / 5`,c.classList.toggle(`lleno`,t)),l&&(l.value=JSON.stringify(n))}function _(e){return Math.log(Math.max(1,Math.min(500,e)))/Math.log(500)*100}function v(){if(!u||!d||!f||!p)return;let e=Number(u.value)||0,t=Number(d.value)||0,n=t<e||e<1;f.style.left=`${_(e)}%`,f.style.right=`${100-_(t)}%`,p.textContent=n?`El máximo no puede ser menor que el mínimo.`:`Eventos de ${e} a ${t} personas.`,p.classList.toggle(`invalido`,n)}i?.addEventListener(`click`,()=>{let e=r?.value.trim()??``;!e||t.length>=10||(t.includes(e)||t.push(e),r&&(r.value=``),h(),r&&!r.disabled&&r.focus())}),r?.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),i?.click())}),document.querySelectorAll(`.opcion`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.categoria??``,r=n.indexOf(t);r===-1?n.length<5&&n.push(t):n.splice(r,1),g()})}),u?.addEventListener(`input`,v),d?.addEventListener(`input`,v),e.addEventListener(`submit`,e=>{let r=Number(u?.value),i=Number(d?.value),a=``;if(t.length?n.length?(!Number.isFinite(r)||!Number.isFinite(i)||i<r||r<1)&&(a=`Revisa el rango de asistentes: el máximo no puede ser menor que el mínimo.`):a=`Marca al menos una categoría en la que trabajas.`:a=`Añade al menos un producto que ofrezcas.`,a){e.preventDefault(),m&&(m.textContent=a,m.hidden=!1);return}m&&(m.hidden=!0)}),h(),g(),v()}"],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/chat-prueba.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`hilo`),t=document.getElementById(`chat-form`),n=document.getElementById(`entrada`),r=document.getElementById(`estado-chat`),i=document.getElementById(`borrador`),a=document.getElementById(`reiniciar`),o=document.getElementById(`candidato`);if(e&&t&&n&&r&&i&&o){let s=[],c=`prueba-${Math.random().toString(36).slice(2,10)}`,l=[[`company_name`,`Empresa`],[`full_name`,`Contacto`],[`email`,`Correo`],[`phone`,`Teléfono`],[`services`,`Categorías`],[`products`,`Ofrece`],[`volume_min`,`Asistentes`],[`description`,`Nota`],[`privacy_consent`,`Autoriza datos`],[`marketing_consent`,`Novedades`]];function u(t,n){let r=document.createElement(`div`);r.className=`chat-burbuja ${n}`,r.textContent=t,e.appendChild(r),e.scrollTop=e.scrollHeight}function d(e){i.innerHTML=``;for(let[t,n]of l){let r=e[t];t===`volume_min`&&(r=e.volume_min===void 0?void 0:`de ${e.volume_min} a ${e.volume_max}`),Array.isArray(r)&&(r=r.join(`, `)),typeof r==`boolean`&&(r=r?`sí`:`no`),r===null&&(r=`—`);let a=document.createElement(`div`);r===void 0&&(a.className=`pendiente`);let o=document.createElement(`dt`);o.textContent=n;let s=document.createElement(`dd`);s.textContent=r===void 0?`Pendiente`:String(r),a.append(o,s),i.appendChild(a)}}async function f(e,t=!1){r.textContent=`Pensando…`,n.disabled=!0;try{let i=s.find(e=>e.providerId===o.value),a=await(await fetch(`/api/chat/test`,{method:`POST`,headers:{\"content-type\":`application/json`},body:JSON.stringify({sessionId:c,message:e,reset:t,...t&&i?{provider:i}:{}})})).json();if(!a.ok){r.textContent=`Error: ${a.error}`;return}u(a.reply,`bot`),d(a.draft??{}),r.textContent=a.finished?a.submissionId?`Ficha guardada · ${a.submissionId.slice(0,8)}`:`Conversación cerrada`:`Listo · ${a.outcome}`,a.finished&&(n.dataset.cerrado=`true`)}catch{r.textContent=`No se pudo contactar al servidor`}finally{n.dataset.cerrado||(n.disabled=!1),n.focus()}}t.addEventListener(`submit`,async e=>{e.preventDefault();let t=n.value.trim();t&&(u(t,`persona`),n.value=``,await f(t))});async function p(){e.innerHTML=``,delete n.dataset.cerrado,await f(``,!0)}a?.addEventListener(`click`,p),o.addEventListener(`change`,p),fetch(`/api/chat/test`).then(e=>e.json()).then(e=>{if(e.ok){s=e.candidates??[];for(let e of s){let t=document.createElement(`option`);t.value=e.providerId,t.textContent=`${e.displayName}${e.city?` · ${e.city}`:``}${e.category?` · ${e.category}`:``}`,o.appendChild(t)}r.textContent=`Listo · ${s.length} candidatos`,u(e.greeting,`bot`),d({})}}).catch(()=>{r.textContent=`No se pudo cargar el saludo`})}"],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/configuracion.astro?astro&type=script&index=0&lang.ts","var e=`BORRAR TODO`,t=document.querySelector(`#reset-input`),n=document.querySelector(`#reset-boton`),r=document.querySelector(`#reset-conteo`),i=document.querySelector(`#reset-estado`),a={providers:`proveedores`,contacts:`contactos`,campaigns:`campañas`,campaign_sends:`envíos`,campaign_personalizations:`personalizaciones`,email_clicks:`clics`,registration_submissions:`formularios`,provider_sources:`fuentes`};function o(e){let t=Object.entries(e).filter(([,e])=>e>0).map(([e,t])=>`${t} ${a[e]??e}`);return t.length?t.join(` · `):`No hay registros que borrar.`}async function s(){if(r)try{let e=await fetch(`/api/providers/reset`).then(e=>e.json());if(!e.ok)throw Error(e.error??`No se pudo consultar.`);r.textContent=o(e.counts),n&&e.total===0&&(n.disabled=!0)}catch(e){r.textContent=e instanceof Error?e.message:`No se pudo consultar.`}}t?.addEventListener(`input`,()=>{n&&(n.disabled=t.value.trim()!==e)}),n?.addEventListener(`click`,async()=>{if(t?.value.trim()===e){n.disabled=!0,i&&(i.textContent=`Borrando…`);try{let n=await fetch(`/api/providers/reset`,{method:`POST`,headers:{\"content-type\":`application/json`},body:JSON.stringify({confirm:e})}).then(e=>e.json());if(!n.ok)throw Error(n.error??`No se pudo borrar.`);i&&(i.textContent=`Borrados ${n.total} registros. ${o(n.deleted)}`),t&&(t.value=``),await s()}catch(r){i&&(i.textContent=r instanceof Error?r.message:`No se pudo borrar.`),n&&(n.disabled=t?.value.trim()!==e)}}}),s();"],["C:/Users/davidt/Desktop/marketplace-control/frontend/src/pages/campanas/index.astro?astro&type=script&index=0&lang.ts","var e=document.querySelector(`#campaign-form`),t=document.querySelector(`#campaign-result`),n=document.querySelector(`#send-campaign`),r=document.querySelector(`#selection-count`),i=document.querySelector(`#segment-summary`),a=document.querySelector(`#select-visible`),o=document.querySelector(`#clear-selection`),s=document.querySelector(`#qa-test`),c=document.querySelector(`#filter-channel`),l=document.querySelector(`#filter-city`),u=document.querySelector(`#filter-status`),d=document.querySelector(`#filter-category`),f=[...document.querySelectorAll(`[data-recipient]`)],p=()=>[...document.querySelectorAll(`input[name=\"contact_ids\"]:checked`)];function m(){let e=p().length;r&&(r.textContent=`${e} seleccionado${e===1?``:`s`}`),n&&(n.disabled=e===0||n.dataset.omnisendReady!==`true`)}function h(){let e=c?.value??`all`,t=l?.value??`all`,n=u?.value??`all`,r=d?.value??`all`,a=0,o=0;f.forEach(i=>{let s=(e===`all`||i.dataset.channel===e)&&(t===`all`||i.dataset.city===t)&&(n===`all`||i.dataset.status===n)&&(r===`all`||i.dataset.category===r);i.hidden=!s,s&&(a+=1,i.querySelector(`input:disabled`)||(o+=1))}),i&&(i.textContent=`${a} candidatos · ${o} aptos para correo`)}[c,l,u,d].forEach(e=>e?.addEventListener(`change`,h)),document.querySelectorAll(`input[name=\"contact_ids\"]`).forEach(e=>e.addEventListener(`change`,m)),a?.addEventListener(`click`,()=>{f.filter(e=>!e.hidden).forEach(e=>{let t=e.querySelector(`input[name=\"contact_ids\"]`);t&&!t.disabled&&(t.checked=!0)}),m()}),o?.addEventListener(`click`,()=>{p().forEach(e=>{e.checked=!1}),m()}),e?.addEventListener(`submit`,async r=>{r.preventDefault();let i=p().map(e=>e.value);if(!i.length||!window.confirm(`Enviar correo a ${i.length} candidatos seleccionados?\\n\\nOmnisend crea un segmento real para este lote antes de enviar; puede tardar hasta 1-2 minutos, no se cierre la pestaña.`))return;n&&(n.disabled=!0),t&&(t.textContent=`Enviando campaña… (creando segmento en Omnisend, puede tardar hasta 2 minutos)`);let a=Object.fromEntries(new FormData(e));a.contact_ids=i;let o=await fetch(`/api/campaigns`,{method:`POST`,headers:{\"content-type\":`application/json`},body:JSON.stringify(a)}),s=await o.json().catch(()=>({}));t&&(t.textContent=o.ok?`Envío terminado: ${s.sent} enviados, ${s.failed} fallidos.`:`No se pudo enviar: ${s.error??`error desconocido`}.`),o.ok?window.setTimeout(()=>window.location.reload(),900):m()}),document.querySelectorAll(`.stats-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.omnisendCampaignId,n=document.querySelector(`[data-stats-for=\"${t}\"]`);if(!n)return;n.textContent=`Consultando…`;let r=await fetch(`/api/campaigns/${t}/stats`),i=await r.json().catch(()=>({}));n.textContent=r.ok&&i.stats?`Entregados: ${i.stats.delivered} · Abiertos: ${i.stats.opened} · Clics: ${i.stats.clicked} · Rebotes: ${i.stats.bounced}`:`No disponible (${i.error??`error desconocido`})`})}),s?.addEventListener(`click`,async()=>{if(!e?.reportValidity())return;let n=s.dataset.recipients??`destinatarios QA`;if(!window.confirm(`Enviar prueba a: ${n}?`))return;s.disabled=!0,t&&(t.textContent=`Enviando prueba QA…`);let r=Object.fromEntries(new FormData(e));r.confirm=`true`;let i=await fetch(`/api/campaigns/qa-test`,{method:`POST`,headers:{\"content-type\":`application/json`},body:JSON.stringify(r)}),a=await i.json().catch(()=>({}));t&&(t.textContent=i.ok?`Prueba enviada a: ${(a.recipients??[]).join(`, `)||n}.`:`No se pudo enviar prueba: ${a.error??`error desconocido`}.`),s.disabled=!1}),h(),m();"]],"assets":["/_astro/index.astro_astro_type_script_index_0_lang.pSqK3ihJ.js","/_astro/AppLayout.Dv_Rtpeg.css","/_astro/index.Daq0HVb3.css","/_astro/index.CuptoqrG.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"JcGjk33s+OmHudOpYwrqu7meDvfWtscSpzfy8GHGkJE=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "6a5e226a-4658-480a-94d0-7648f1c4fb44") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
